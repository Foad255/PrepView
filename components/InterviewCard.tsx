      ...
      <div className="card-interview">
        <div>
          ...
          <div className="flex flex-row gap-5 mt-3">
            ...
            <div className='flex flex-row gap2 item-center' >
              <Image src="/star.svg" alt="user" width={22} height={22}/>
          ...
          <div className="flex flex-row justify-between">
            ...
            <Button className="btn-primary">
              <Link href={feedback? `/interview/${interviewId}/feeback` : `/interview/${interviewId}`}>
